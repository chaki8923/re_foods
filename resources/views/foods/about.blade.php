...
<div class="main-content">
  ...
  <div class="main-content-inner">
    ...
    <div class="main-content-image">
      <img src="{{asset('storage/images/hand.jpg')}}" alt="" class="js-slide slide1">
      <img src="{{asset('storage/images/radexish.jpg')}}" alt="" class="js-slide slide2">
      <img src="{{asset('storage/images/vegitable.jpg')}}" alt="" class="js-slide slide3">
    </div>
    ...
    <div class="main-content-image">
      <img src="{{asset('storage/images/safe_person.png')}}" class="">
    ...
    <div class="main-content-image">
      <img src="{{asset('storage/images/baravegi.jpg')}}" alt="" class="js-slide slide1">
      <img src="{{asset('storage/images/orange.jpg')}}" alt="" class="js-slide slide2">
      <img src="{{asset('storage/images/pan.jpg')}}" alt="" class="js-slide slide3">
    </div>
    <section class="discription">
    ...
    <div class="main-content-image">
      <img src="{{asset('storage/images/eggpalte.jpg')}}" alt="" class="">
    </div>
    <section class="discription">
